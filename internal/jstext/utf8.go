...
func DecodeUTF8(b []byte) string {
	...
	for i := 0; i < len(b); {
		...
		// needed counts the continuation bytes; lower and upper bound the
		// first of them, which is where overlong forms, surrogates and code
		// points past U+10FFFF are ruled out.
